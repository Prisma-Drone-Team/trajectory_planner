...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_qos',                    'default': 'SENSOR_DATA', 'description': 'QOS depth'},
                           {'name': 'color_qos',                    'default': 'SENSOR_DATA', 'description': 'QOS color'},
                           {'name': 'infra1_qos',                    'default': 'SENSOR_DATA', 'description': 'QOS infra1'},
                           {'name': 'infra2_qos',                    'default': 'SENSOR_DATA', 'description': 'QOS infra2'}
                          ]
