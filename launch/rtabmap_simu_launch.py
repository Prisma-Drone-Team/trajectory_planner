...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/camera',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/depth_camera', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/camera_info',            description=''),
